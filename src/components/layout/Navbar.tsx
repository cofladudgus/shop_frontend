  ...
  return (
    <nav className='bg-gray-100'>
        ...
        <div className='flex justify-between'>
          <div className='flex space-x-4'>
            ...
            <div className='hidden md:flex items-center space-x-1'>
              <Link href='/features' className='py-5 px-3 text-gray-700 hover:text-gray-900'>
                Features
              </Link>
          ...
          {/* secondary nav */}
          <div className='hidden md:flex items-center space-x-1'>
            <button className='py-5 px-3' onClick={Login}>
              Login
            </button>
            <a
              href='#'
          ...
          <div className='md:hidden flex items-center'>
            <button onClick={() => setMenuToggle(!menuToggle)}>
              {menuToggle ? <XIcon className='w-6 h-6' /> : <MenuIcon className='w-6 h-6' />}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className={`${!menuToggle ? 'hidden' : ''} md:hidden`}>
        ...
        <button className='block py-2 px-4 text-sm hover:bg-gray-200' onClick={Login}>
          Login
        </button>
        <Link href='#' className='block py-2 px-4 text-sm hover:bg-gray-200'>
          Signup
